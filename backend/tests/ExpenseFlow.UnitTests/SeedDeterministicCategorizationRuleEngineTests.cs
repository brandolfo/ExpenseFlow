...
public sealed class SeedDeterministicCategorizationRuleEngineTests
{
    ...
    [Fact]
    public void KnownMerchantExactMatchCategorizesAndPreservesRuleInformation()
    {
        var transaction = Categorize(Row(1, "FRESHVALE MARKET DEMO", 34500m));
        ...
        Assert.Contains(transaction.RuleMatches, match => match.RuleId == "R001" && match.Pattern == "FRESHVALE MARKET");
    }

    [Fact]
    public void DescriptionKeywordContainsMatchCategorizes()
    {
        ...
        Assert.Contains(transaction.RuleMatches, match => match.RuleId == "R004");
    }
    ...
    public void RefundLikeNegativeAmountIsVisibleAndExcluded()
    {
        ...
        Assert.False(transaction.IncludedInProcessedTotal);
        Assert.False(transaction.IncludedInCategoryTotals);
        Assert.Contains(transaction.RuleMatches, match => match.RuleId == "R013");
    }
    ...
    public void TransferOrPaymentLikeRowIsVisibleAndExcluded()
    {
        ...
        Assert.False(transaction.IncludedInProcessedTotal);
        Assert.False(transaction.IncludedInCategoryTotals);
        Assert.Contains(transaction.RuleMatches, match => match.RuleId == "R014");
    }
    ...
    [Fact]
    public void CategorizationDoesNotRequireAiOrCalculateTotals()
    {
