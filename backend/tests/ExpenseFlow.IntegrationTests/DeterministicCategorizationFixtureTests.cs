...
public sealed class DeterministicCategorizationFixtureTests
{
    ...
    public async Task DemoMainCategorizesValidRowsWithExpectedReviewExclusionAndDuplicateOutcomes()
    {
        ...
        AssertRow(transactions, 16, RowStatus.Categorized, ExpenseCategory.Shopping, reviewReason: null, includedInProcessedTotal: true, includedInCategoryTotals: true, ruleIds: ["R015"]);
